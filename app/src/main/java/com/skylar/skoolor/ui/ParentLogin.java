    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent(ParentLogin.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
                ...
                if (un.length() < 2) {
                    ...
                    DbStudents.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            if (a == 0) {
                                Toast.makeText(ParentLogin.this, "Please enter correct username and roll number of student", Toast.LENGTH_SHORT).show();
                            } else {
                                ...
                                Intent i = new Intent(ParentLogin.this, ParentBoard.class);
                                startActivity(i);
                                finish();
                            }
                        }
                ...
                DbParents.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot d1 : dataSnapshot.getChildren()) {
                            ...
                            Toast.makeText(ParentLogin.this, "cc"+data.getStUsername(), Toast.LENGTH_SHORT).show();
                        ...
                        if (a == 0) {
                            Toast.makeText(ParentLogin.this, "Please enter correct username and password", Toast.LENGTH_SHORT).show();
                        }
